...
The status bar is a planned but **not yet implemented** feature of aislopdesk's UI shell. No screenshots, configuration keys, keybindings, or full behavioral specification have been finalized yet.
...
### Constraints from aislopdesk's remote-host architecture
