...
| **Themes — Monokai Pro 6-filter + Paper + Dark + System** | done | `AppearancePreferences.swift:31–42` — `ThemeChoice` enum with 9 cases; `ThemeStore.swift:44–66` — `apply(_:)` resolves to `SlateTheme`; wired in `AislopdeskClientApp.swift:65–67` |
