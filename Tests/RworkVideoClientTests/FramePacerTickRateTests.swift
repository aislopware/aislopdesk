...
/// native refresh, floored at the host content fps, with `RWORK_TICK_HZ` as the A/B override.
...
final class FramePacerTickRateTests: XCTestCase {
    ...
    func testEnvOverrideWinsAndClamps() {
        // RWORK_TICK_HZ beats the resolved display rate (A/B without rebuild).
