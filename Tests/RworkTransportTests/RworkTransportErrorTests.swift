...
final class RworkTransportErrorTests: XCTestCase {
    ...
    func testErrorDescriptionIsCleanAndOmitsDetailPayload() {
        ...
        let cases: [(RworkTransportError, String, String)] = [
            (.timedOut("connect to 10.0.0.1:7777 exceeded 10s"), "Connection timed out — host unreachable?", "10.0.0.1"),
            (.handshakeFailed("bad preamble"),                    "Handshake failed — is this an rwork host?", "preamble"),
