...
final class IPCGuardTests: XCTestCase {
    ...
    func testIPCGuardEnvDefaultsOffAndRequiresExplicit1() {
        ...
        XCTAssertFalse(HostEnvironment.ipcAllowSendKeys(environment: ["AISLOPDESK_IPC_ALLOW_SEND_KEYS": "0"]))
        XCTAssertFalse(HostEnvironment.ipcAllowSendKeys(environment: ["AISLOPDESK_IPC_ALLOW_SEND_KEYS": "yes"]))
        XCTAssertTrue(HostEnvironment.ipcAllowSendKeys(environment: ["AISLOPDESK_IPC_ALLOW_SEND_KEYS": "1"]))

        XCTAssertFalse(HostEnvironment.ipcAllowSensitiveSessions(environment: [:]))
        XCTAssertFalse(HostEnvironment.ipcAllowSensitiveSessions(environment: ["AISLOPDESK_IPC_ALLOW_SENSITIVE": "0"]))
        XCTAssertTrue(HostEnvironment.ipcAllowSensitiveSessions(environment: ["AISLOPDESK_IPC_ALLOW_SENSITIVE": "1"]))
    }
