...
final class VideoWireTypeTests: XCTestCase {
    ...
    func testControlHelloRoundTrip() throws {
        let message = VideoControlMessage.hello(protocolVersion: RworkVideoProtocol.version, requestedWindowID: 0xDEAD_BEEF, viewport: VideoSize(width: 1280.5, height: 800.25))
