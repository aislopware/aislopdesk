...
/// A multicast ("tee") for ``RworkClient/Event``: fans ONE upstream event source out to
...
/// `RworkClient` has multiple legitimate event consumers at once — `ReconnectManager`
