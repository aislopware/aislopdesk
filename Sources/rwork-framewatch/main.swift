// rwork-framewatch — objective frame-cadence instrument (2026-06-10 khựng hunt).
//
...
// directly comparable across Rwork and Parsec windows on the same machine.
//
// Usage: rwork-framewatch --title <substring> [--seconds 20] [--fps 120] [--list]
//        rwork-framewatch --latency --title-a <source> --title-b <client> [--seconds 30]
...
RunLoop.main.run()
#else
fatalError("rwork-framewatch is macOS-only")
#endif
