...
/// focus?
///
/// WHY this lives in aislopdesk and not libghostty: libghostty's OWN `focus-follows-mouse` config key only
/// relays focus inside ghostty's INTERNAL split tree, but each aislopdesk pane is a SEPARATE `GhosttySurface`
