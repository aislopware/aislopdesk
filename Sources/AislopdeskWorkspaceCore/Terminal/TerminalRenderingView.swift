...
// `AislopdeskWorkspaceCore`. The rebuilt `AislopdeskClientUI` provides the real placeholder/renderer
...
public final class TerminalRendererFactory {
    ...
    /// pane's workspace focus. The rebuilt `AislopdeskClientUI`/app target always registers a
