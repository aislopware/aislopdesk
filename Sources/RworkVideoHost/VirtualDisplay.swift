...
@preconcurrency import CRworkVirtualDisplay
import OSLog
...
/// - The process must keep a live run loop (rwork-videohostd switches `dispatchMain()` →
...
public final class VirtualDisplay {
    private let log = Logger(subsystem: "rwork.video.host", category: "VirtualDisplay")
    ...
    public func create(_ geometry: VirtualDisplayGeometry, name: String = "Rwork Remote") async -> CGDirectDisplayID? {
        ...
        desc.queue = DispatchQueue(label: "rwork.video.vd.termination")
        desc.terminationHandler = { _, reason in
            ...
            Logger(subsystem: "rwork.video.host", category: "VirtualDisplay")
