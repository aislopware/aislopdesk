...
/// CONTENT-ADAPTIVE FPS (2026-06-09) — the capability rwork lacked vs Parsec.
///
...
///
/// Parsec's fix (and now rwork's): under heavy motion DROP the frame rate. Fewer frames means each gets a
...
public final class AdaptiveFPSController: @unchecked Sendable {
    ...
    /// When false (`RWORK_ADAPTIVE_FPS=0`), `shouldSkip` always returns false ⇒ byte-identical to full fps.
