...
extension RworkTransportError: LocalizedError {
    ...
    /// produces a developer dump ("The operation couldn't be completed. (RworkTransport… error 7.)")
    ...
    public var errorDescription: String? {
        ...
        case .handshakeFailed:  return "Handshake failed — is this an rwork host?"
