...
/// (``PreventSleepAssertion``) holds the actual assertion and is driven by this verdict in `aislopdesk-hostd`.
///
...
/// The toggle reaches the host via the ``AgentPreferences`` sidecar (`AISLOPDESK_AGENT_PREVENT_SLEEP`,
