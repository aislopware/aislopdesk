...
//
// This is the resurrected, native-Swift port of the Rust `aislopdesk-core::gf256` reference
...
//
// `NeonGf` delegates the hot region multiply to the `CAislopdeskSIMD` C kernel (a tiny C target
...
/// SIMD `GfRegion` that delegates the inner loop to the `CAislopdeskSIMD` C kernel (aarch64 NEON +
