...
//
// This is the resurrected, native-Swift port of the Rust `aislopdesk-core::scroll_shift` reference
// (`estimate_vertical_shift`) PLUS the `aislopdesk-ffi::video::scroll_shift` per-row hashing + the
