...
//
// This is the resurrected, native-Swift port of the Rust `aislopdesk-core::frame_hash` reference
...
// ## Why no NEON kernel
//
// An xxHash64-block NEON kernel once folded the aligned 32-byte blocks via `CAislopdeskSIMD`, but
