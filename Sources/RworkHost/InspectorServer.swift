...
public final class InspectorServer: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "rwork.inspector.listener")
...
/// Errors distinct from `RworkTransportError` for the inspector listener.
...
/// continuation exactly once (mirrors `RworkTransport`'s internal `ReadyBox`, which is
