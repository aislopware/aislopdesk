...
/// Top-level namespace for Rwork wire-protocol constants.
///
/// `RworkProtocol` is **pure Swift with zero platform dependency** (no `Network`,
...
public enum Rwork {
    ...
    ///
    /// A length prefix larger than this is rejected with ``RworkError/frameTooLarge(_:)``
