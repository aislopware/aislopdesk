/// Errors thrown while decoding Rwork wire frames.
///
...
/// ``FrameDecoder``).
public enum RworkError: Error, Equatable, Sendable {
    /// A frame's length prefix exceeded ``Rwork/maxFramePayloadLength``.
