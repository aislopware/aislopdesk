...
```sh
bash rust/build-apple.sh   # build libaislopdesk_ffi.a (macOS arm64) AND sync the C header into Sources/CAislopdeskFFI; pass --ios for device+sim slices
