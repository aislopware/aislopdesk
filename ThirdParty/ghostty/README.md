...
control-mode viewer + search + embedded C glue), plus the two aislopdesk patches. The merge
...
`patches/aislopdesk-libghostty-on-v1.3.1.patch` (+ 0001/0002); `build-libghostty.sh` automates it.
